...
│   ├── PropertiesRow (title="Properties") → Badge (status), due date, owner, circle
...
├── SidebarSection "Properties"
│   └── PropertiesRow (stacked)
│       ├── PropertiesRow.Item "Status" → Badge
...
│   │   ├── PropertiesRow.Item → PropertySelect (status)
...
├── SidebarSection "Properties"
│   └── PropertiesRow (stacked)
│       ├── PropertiesRow.Item "Status" → PropertySelect
