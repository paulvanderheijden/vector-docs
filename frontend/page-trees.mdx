...
└── SidebarSection "Properties"
    └── PropertiesRow (stacked)
        ...
        ├── PropertiesRow.Item "Requested" → PersonField (read-only, showName)
        ├── PropertiesRow.Item "Age" → colored text
        ├── PropertiesRow.Item "Circle" → Link
        ├── PropertiesRow.Item "Sponsor" → PersonField (editable, showName)
        └── PropertiesRow.Item "Owner" → PersonField (editable, showName)
```
