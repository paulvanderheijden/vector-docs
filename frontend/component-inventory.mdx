...
**Used in:** Strategy (main content), DecisionDetail (description, discussion, summary), CommitmentDetail (linked decision), InitiativeDetail (description), SessionDetail (meeting notes)
...
**Used in:** AppSidebar, Inbox, MyItems, InitiativesList, ProjectsList, ProjectDetail, InitiativeDetail, CircleDecisions, CircleCommitments, SessionsList, SessionDetail, DecisionDetail, CommitmentDetail, Strategy
