...
Avatar-based person display. Read-only shows avatar + optional name. Editable shows avatar that opens a popover picker with the full people list.
...
**Used in:** DecisionsTable (owner/sponsor cell), CommitmentsTable (owner cell), InitiativesList (owner cell), InitiativeDetail (project table), ProjectsList (owner cell), Strategy (header, author)
...
**Used in:** DecisionsTable (status cell, combined statusOwner cell), CommitmentsTable (status cell)
