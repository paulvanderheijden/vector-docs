...
| **rolled** set to `true` | Decision marked as rolled | `"marked as rolled"` | — | — |
| **rolled** set to `false` | Roll flag cleared | `"cleared rolled flag"` | — | — |
| statement change | — | *no event* | — | — |
| description change | — | *no event* | — | — |
| discussion change | — | *no event* | — | — |
| summary change | — | *no event* | — | — |
| requestedDate change | — | *no event* | — | — |
| projects change | — | *no event* | — | — |
...
| **project** change | Project assigned/changed | `"changed project"` | old project title | new project title |
| outcome change | — | *no event* | — | — |
| description change | — | *no event* | — | — |
...
| title change | — | *no event* | — | — |
| notes change | — | *no event* | — | — |
