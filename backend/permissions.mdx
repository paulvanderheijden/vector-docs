...
| Propose a decision to a circle <br />(assigning to a circle) | yes              | yes              | yes              |
| View decisions in a circle                                   | —                | yes              | yes              |
| Assigned a sponsor                                           | —                | yes (own circle) | yes (own circle) |
...
| Create a commitment             | —                | yes (own circle) | yes (own circle) |
...
An explicit permission model (e.g., role-based access control with a permissions table) would require maintaining role assignments separately from the data. In Vector, the data _is_ the permission model:
